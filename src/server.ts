...
server.post('/users/:userId/address/', loginRequired, addressesController.create)
server.get('/users/:userId/address/', loginRequired, addressesController.list)
server.put('/users/:userId/address/:id', loginRequired, addressesController.update)
server.delete('/users/:userId/address/:id', loginRequired, addressesController.delete)
server.get('/users/:userId/address/:id', loginRequired, addressesController.show)
